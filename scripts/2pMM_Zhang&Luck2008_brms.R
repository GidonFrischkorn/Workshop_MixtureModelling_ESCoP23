...
pacman::p_load(here, brms, tidyverse, tidybayes, patchwork, gghalves, bmm, bayestestR)
...
ZL_mixPriors <- 
  ...
  prior(normal(0,2), class = "b", dpar = "theta1") +
  prior(normal(0,2), class = "b", dpar = "kappa1")
...
bf_parameters(fit_ZL_mixModel)

# test
describe_posterior(fit_ZL_mixModel, ci_method = "hdi")
